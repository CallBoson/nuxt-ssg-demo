...
(function () {
  ...
  const NODE_JS = !root.JS_MD5_NO_NODE_JS && typeof process === 'object' && process.versions && process.versions
    .node
  if (NODE_JS) {
    root = global
  }
  ...
  Md5.prototype.update = function (message) {
    ...
    let i; const length = message.length || 0
  ...
  Md5.prototype.hash = function () {
    let a; let b; let c; let d; let bc; let da; const blocks = this.blocks
